(function() {
  ...
  // ================================================
  // == DATA POIN CHIEF CHARMS, TROOPS & PROMOTION ==
  // ================================================
  const CHARM_POINTS = {
    1: 625,    //
    2: 1250,   //
  ...
  // =============================================
  // == DATA POIN TROOPS (BERDASARKAN 2025) ==
  // =============================================
  const TROOP_POINTS = {
    0: 0,
    1: 1,
  ...
  function updateTotals() {
    ...
    if (promoRow) {
      ...
      // === PERBAIKAN DI SINI ===
      // Sebelumnya: row.querySelector... (SALAH)
      // Seharusnya: promoRow.querySelector... (BENAR)
  ...
  backBtn?.addEventListener('click', e => {
    ...
    // === GANTI ISI PESAN DALAM BOX ALERT === //
    showCustomAlert(
